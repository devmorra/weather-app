...
form.addEventListener('submit', async (event) =>{
    ...
    if (weatherData.cod == 200){
        ...
        highTempDiv.innerHTML = weatherData.main.temp_max;
        lowTempDiv.innerHTML = weatherData.main.temp_min;
        pressureDiv.innerHTML = weatherData.main.pressure;
        let tempFeelsLike = weatherData.main.feels_like;
        windSpeedDiv.innerHTML = `${weatherData.wind.speed} mph`;
        windGustDiv.innerHTML = weatherData.wind.gust;
        windDirDiv.innerHTML = weatherData.wind.deg;
